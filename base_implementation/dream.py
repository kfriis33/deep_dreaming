# Dream.py – Base Deep Dream Implementation
# Algorithm based off of tutorial by Magnus Erick Hvass Pederson (see https://hackernoon.com/deep-dream-with-tensorflow-a-practical-guide-to-build-your-first-deep-dream-experience-f91df601f479)
