# dream_layer_combination.py – Deep Dream implementation where we can optimize over a weighted combination of layers
# rather than just one.
# Most of algorithm code is copied over from dream.py and is redundant. recursive_optimize and optimize_image is
# where most of the original code lies.
